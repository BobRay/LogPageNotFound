 ...
 * When you select LogPageNotFound on the Components menu.
...
$modx->regClientCSS($path . 'components/logpagenotfound/css/logpagenotfound.css');
$output = '<div class="logpagenotfound">';
