<?php
/**
 * Utility snippet for LogPageNotFound development
 *
...
$sources= array (
    'root' => $root,
    'build' => $root . '_build/',
    'source_core' => $root . 'core/components/logpagenotfound',
    'source_assets' => $root . 'assets/components/logpagenotfound',
    'data' => $root . '_build/data/',
    'docs' => $root . 'core/components/logpagenotfound/docs/',
);
unset($root);
...
$category = $modx->getObject('modCategory', array('category'=>'LogPageNotFound'));

if (! $category) {
    $category= $modx->newObject('modCategory');
    $category->set('category','LogPageNotFound');
}
